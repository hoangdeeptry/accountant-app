...
namespace QuanLyBanHang
{
    public partial class FrmQLKhachHang : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show("Agency name is invalid.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
                    else if (dtNgaySinh.Value.Date >= DateTime.Now.Date)
                    {
                        MessageBox.Show("Birthdate is invalid.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
                    ...
                    else
                    {
                        ...
                        db.SubmitChanges();
                        MessageBox.Show("Agency added successfully.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        ClearTxt();
                        LoadDataKhachHang();
                    }
                }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please choose an agency to delete.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else
            {
                if (MessageBox.Show("Are you sure? This action cannot be undone.", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    else
                    {
                        ...
                        db.SubmitChanges();
                        MessageBox.Show("Agency deleted successfully.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        ClearTxt();
                        LoadDataKhachHang();
                    }
                }
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtMaKH.Text.Trim().Length.Equals(0))
                {
                    MessageBox.Show("Please choose an agency to edit.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        db.SubmitChanges();
                        MessageBox.Show("Agency edited successfully.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        ClearTxt();
                        LoadDataKhachHang();
                    }
                }
