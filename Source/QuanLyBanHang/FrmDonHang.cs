...
namespace QuanLyBanHang
{
    public partial class FrmDonHang : Form
    {
        ...
        private void xuatfileExcel(DataGridView g, string path, string filename)
        {
            app obj = new app();
        ...
        {
            xuatfileExcel(dataHoaDon, @"C:\Users\Admin\Pictures\", "Export");
            MessageBox.Show("Excel file exported successfully.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
