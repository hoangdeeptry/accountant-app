...
namespace QuanLyBanHang
{
    public partial class FrmQLNhanVien : Form
    {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please choose an user to delete.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else
            {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtMaNV.Text.Trim().Length.Equals(0))
                {
                    MessageBox.Show("Please choose an user for editing.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                else
                {
                    ...
                    {
                        MessageBox.Show("Số điện thoại không đúng định dạng", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        return;
                    }
                    else
                    {
