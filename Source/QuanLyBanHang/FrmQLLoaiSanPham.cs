    ...
    public partial class FrmQLLoaiSanPham : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Please fill in goods type name.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                else if (!Model.checkIsLetter(txtTenLoai.Text))
                {
                    MessageBox.Show("Goods type name is invalid.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    txtTenLoai.Focus();
                }
                else
                {
                    ...
                    if (checkTenL != null)
                    {
                        MessageBox.Show("This type is already exist.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
                    else
                    {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please choose a type to delete.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else
            {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtMaTL.Text.Trim().Length.Equals(0))
                {
                    MessageBox.Show("Please choose a type for editing.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                if (txtTenLoai.Text.Trim().Length.Equals(0))
                {
                    MessageBox.Show("Please fill in type name for editing.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                else if (!Model.checkIsLetter(txtTenLoai.Text))
                {
                    MessageBox.Show("Type name is invalid.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    txtTenLoai.Focus();
                }
                else
                {
                    ...
                    if (l == null)
                    {
                        MessageBox.Show("This type is not exist.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
                    else
                    {
                        l.TenLoaiSP = txtTenLoai.Text.Trim();
